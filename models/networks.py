...
def define_D(input_nc, ndf, netD, n_layers_D=3, norm='batch', init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    ##################################### CODE ADDED / START #####################################
        ...
        net = UnetDiscriminator(image_size=256, network_capacity = 32, transparent = False, fmap_max = 512)
    ###################################### CODE ADDED / END ######################################
...
class UnetDiscriminator(nn.Module):
    def __init__(self, image_size, network_capacity=64, transparent = False, fmap_max = 512):
        super().__init__()
